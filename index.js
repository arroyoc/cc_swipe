...
const validFowardSwipeSpeed = 55
...
//The following request will push the credit card through the reader very slowly. resulting in an invalid swipe error
app.get('/slowswipe', (req, res) => {
    if (ready) {
